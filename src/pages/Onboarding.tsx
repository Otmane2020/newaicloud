      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          ...
          <Card className="p-6 border-2 border-border">
            ...
            <Button className="w-full" onClick={() => handleSelectPlan("advanced")}>
              Choose Plan
            </Button>
          </Card>
          ...
          <Card className="p-6 border-2 border-primary relative">
            ...
            <Button className="w-full bg-primary" onClick={() => handleSelectPlan("recommended")}>
              Choose Plan
            </Button>
          </Card>
          ...
          <Card className="p-6 border-2 border-border">
            ...
            <Button className="w-full" onClick={() => handleSelectPlan("max")}>
              Choose Plan
            </Button>
          </Card>
        </div>
