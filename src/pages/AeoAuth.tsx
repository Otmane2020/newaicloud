...
export default function AeoAuth() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-violet-950/20 to-slate-950 flex items-center justify-center px-4 py-12">
      {/* Background Effects */}
      ...
      <Card className="w-full max-w-md p-8 bg-slate-900/80 backdrop-blur-xl border-violet-500/20 relative z-10">
        {/* Language Switcher */}
          ...
          {mode === 'signup' && (
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-slate-800/50 border-violet-500/30 text-white placeholder:text-white/40 focus:border-violet-500"
              />
              {errors.fullName && (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                placeholder="••••••••"
                minLength={6}
                className="bg-slate-800/50 border-violet-500/30 text-white placeholder:text-white/40 focus:border-violet-500 pr-10"
              />
              <button
                type="button"
        ...
        <div className="my-6 flex items-center gap-4">
          <Separator className="flex-1 bg-violet-500/20" />
        ...
        <Button
          variant="outline"
          className="w-full border-violet-500/30 text-white hover:bg-violet-500/10"
