...
import { Info, Loader2, ShoppingBag, Key, Shield, ExternalLink } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-[550px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 p-4 border rounded-lg bg-card">
            ...
            <p className="text-sm text-muted-foreground">Connexion OAuth sécurisée (nécessite le nom de boutique)</p>
            ...
            <div className="space-y-3">
              ...
              <Button onClick={handleOAuthConnect} disabled={oauthLoading} className="w-full" variant="outline">
                {oauthLoading ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    Connexion...
