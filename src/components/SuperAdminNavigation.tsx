import { Shield, Users, Mail, LogOut, BarChart3, Home, FileText, TrendingUp, Activity, Brain, FileWarning, Wrench, Search, Target, Globe, Languages, ScanSearch, Video, Share2 } from "lucide-react";
...
export function SuperAdminNavigation({ activeTab, onTabChange }: SuperAdminNavigationProps) {
  ...
  const navItems = [
    ...
    {
      icon: Globe,
      label: t.superAdmin.navigation.blogSeo || "Blog SEO",
      id: "blog-seo"
    },
    {
      icon: Activity,
    ...
    {
      icon: Brain,
      label: t.superAdmin.navigation.insights,
      id: "insights"
    },
    {
      icon: FileWarning,
      label: t.superAdmin.navigation.logs,
      id: "logs"
    },
    {
      icon: Wrench,
      label: t.superAdmin.navigation.toolbox,
      id: "toolbox"
    },
    {
      icon: Search,
      label: t.superAdmin.navigation.search,
      id: "search"
    },
    {
      icon: Languages,
    ...
    {
      icon: Video,
      label: t.superAdmin.navigation.videoAds || "🎬 Video Ads",
      id: "video-ads"
    },
    {
      icon: Globe,
      label: t.superAdmin.navigation.googleSearchConsole || "Google Search Console",
      id: "google-search-console"
    },
    {
      icon: Share2,
      label: t.superAdmin.navigation.socialMedia || "Social Media",
      id: "social-media"
    },
  ];
  return (
