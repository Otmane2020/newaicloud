...
import { Sparkles, Check, Settings2, Eye, Wand2 } from "lucide-react";
import { LandingConfig } from "./LandingConfigDialog";
import { useTranslation } from "@/lib/language";
import { LandingTemplatePreviewModal } from "./LandingTemplatePreviewModal";
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[95vw] md:max-w-[900px] lg:max-w-[1100px] max-h-[90vh]">
          ...
          <div className="space-y-4 max-h-[70vh] overflow-y-auto px-1 pb-4">
                  ...
                  {hoveredTemplate === template.id && (
                    <div className="absolute inset-0 bg-primary/5 flex items-center justify-center pointer-events-none">
                      <div className="text-center p-4">
                        ...
                        <p className="text-sm font-semibold text-primary">Click to preview</p>
                      </div>
                    </div>
                  )}
                </Card>
            ...
            {/* Custom AI Configuration Section */}
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 rounded-xl p-6 border border-purple-500/20">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-lg mb-2">Configuration personnalisée avec IA</h3>
                    <p className="text-sm text-muted-foreground mb-4">
                      Créez une landing page sur mesure en définissant vos propres paramètres de style, couleurs et mise en page.
                    </p>
                    <Button onClick={onCustomize} variant="secondary" className="gap-2">
