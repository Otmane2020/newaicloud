...
export function MinimizableProgressDialog({
  ...
  // Reset minimized state when dialog closes completely
  useEffect(() => {
  ...
  useEffect(() => {
    if (wasProcessing && !isProcessing && (open || isMinimized)) {
  ...
  }, [isProcessing, wasProcessing, open, isMinimized, onComplete]);
        ...
        <div className="fixed bottom-4 right-4 z-50 animate-in slide-in-from-bottom-5">
          <div className="bg-background border border-border rounded-lg shadow-2xl p-4 w-80">
            ...
            {isProcessing && currentProcessing ? (
              ...
              <div className="text-xs text-green-600 flex items-center gap-2 cursor-pointer" onClick={() => setIsMinimized(false)}>
