  ...
  return (
    <div className="bg-gradient-announcement border-b border-primary-light/30 backdrop-blur-sm relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 py-1.5 pr-8 sm:pr-4">
          ...
          <button
            ...
            className="px-3 sm:px-4 py-1.5 rounded-lg bg-accent text-accent-foreground font-semibold text-xs sm:text-sm hover:bg-accent/90 transition-all hover:scale-105 whitespace-nowrap"
          >
