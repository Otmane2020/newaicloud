            ...
            <div className="rounded-lg border bg-muted/50 p-4 space-y-3">
              ...
              <div className="space-y-2 text-sm">
                {currentPlan && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {currentPlan.name} - {currentPrice.toFixed(2)}{getCurrencySymbol(language)}/{billingPeriod === 'monthly' ? 'mois' : 'an'}
                    </span>
                  </div>
                )}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {selectedPlan.name} - {newPrice.toFixed(2)}{getCurrencySymbol(language)}/{billingPeriod === 'monthly' ? 'mois' : 'an'}
                  </span>
                </div>
                ...
                {!isSamePlan && (
                  <div className="flex items-center justify-between pt-2 border-t">
                    ...
                    <span className={`font-semibold ${isUpgrade ? 'text-orange-600' : 'text-green-600'}`}>
                      {isUpgrade ? '+' : ''}{priceChange.toFixed(2)}{getCurrencySymbol(language)}
                    </span>
                  </div>
                )}
              </div>
