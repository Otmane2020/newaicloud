export const translations = {
  ...
  wizards: {
    campaign: {
      ...
      description: "Étape {{step}} sur 4",
      steps: {
        basic: {
          title: "Informations de base",
          subtitle: "Commençons par nommer votre campagne",
          nameLabel: "Nom de la campagne *",
          namePlaceholder: "Ex: Campagne Blog Meubles Printemps 2025",
        ...
        topic: {
          ...
          topicLabel: "Sujet principal *",
          topicPlaceholder: "Ex: Mobilier scandinave, Décoration moderne...",
          topicHelp: "Le thème général des articles à générer",
          keywordsLabel: "SEO Keywords",
          keywordPlaceholder: "Saisissez un mot-clé...",
          addButton: "Ajouter",
          keywordsHelp: "Ajoutez des mots-clés pertinents pour votre campagne pour une meilleure optimisation SEO",
        },
        audience: {
          title: "Audience Cible",
          subtitle: "À qui s'adressent vos articles ?",
          audienceLabel: "Audience cible",
          audiencePlaceholder: "Sélectionnez votre audience",
        ...
        scheduling: {
          ...
          frequencyLabel: "Fréquence de génération",
          daily: "Quotidien",
          weekly: "Hebdomadaire",
          biweekly: "Toutes les 2 semaines",
          monthly: "Mensuel",
          startDateLabel: "Date de démarrage",
          autoPublishLabel: "Publication automatique",
          autoPublishHelp: "Publier les articles dès leur génération",
        },
      },
      actions: {
        back: "Retour",
      ...
      errors: {
        ...
        topicRequired: "Veuillez définir le sujet principal",
        notAuthenticated: "Non authentifié",
        limitReached: "Limite de campagnes atteinte",
        limitDescription: "Passez à un plan payant pour créer plus de campagnes.",
        createError: "Erreur lors de la création de la campagne",
      },
      success: "Campagne créée avec succès !",
    },
    adsCampaign: {
      title: "Nouvelle Galerie Artistique",
      description: "Étape {{step}} sur 6",
      steps: {
        type: {
          nameLabel: "Nom de la campagne *",
        ...
        collections: {
          titleProducts: "Sélection des produits",
          subtitleProducts: "Choisissez les produits à mettre en avant",
          titleCollections: "Sélection des collections",
          subtitleCollections: "Choisissez les collections à mettre en avant",
          titleStore: "Résumé boutique",
          subtitleStore: "Créez une vue d'ensemble de votre boutique",
          searchPlaceholder: "Rechercher...",
          noResults: "Aucun résultat trouvé",
          selected: "sélectionné(s)",
          generateSummary: "Générer le résumé",
          generating: "Génération...",
          summaryLabel: "Résumé de la boutique",
          summaryPlaceholder: "Le résumé de votre boutique apparaîtra ici...",
        },
        products: {
          title: "Sélection des produits",
          subtitle: "Choisissez les produits à mettre en avant dans votre galerie",
          searchPlaceholder: "Rechercher des produits...",
          noProducts: "Aucun produit trouvé",
          selected: "sélectionné(s)",
        },
        highlights: {
          title: "Points forts de la campagne",
          subtitle: "Ajoutez des arguments clés à mettre en avant",
          inputLabel: "Ajouter un point fort",
          inputPlaceholder: "Ex: Livraison gratuite, Garantie 30 jours...",
          addButton: "Ajouter",
          noHighlights: "Aucun point fort ajouté pour le moment",
        },
        content: {
          title: "Contenu & Call-to-Action",
          subtitle: "Définissez vos messages principaux",
          headlineLabel: "Titre principal *",
          headlinePlaceholder: "Ex: Découvrez notre nouvelle collection été",
          subheadlineLabel: "Sous-titre",
          subheadlinePlaceholder: "Ex: Des meubles modernes et élégants pour votre intérieur",
          ctaLabel: "Bouton d'action *",
          ctaPlaceholder: "Ex: Découvrir la collection",
        },
        design: {
          title: "Style de design",
          subtitle: "Choisissez le style visuel de votre landing page",
          artistic: {
            title: "Artistique",
            description: "Design créatif et audacieux avec effets visuels",
          },
          minimal: {
            title: "Minimaliste",
            description: "Design épuré et élégant centré sur l'essentiel",
          },
          bold: {
            title: "Audacieux",
            description: "Design percutant avec couleurs vives et typographie large",
          },
        },
      },
      actions: {
      ...
      errors: {
        typeRequired: "Veuillez sélectionner un type de campagne",
        nameRequired: "Veuillez donner un nom à votre campagne",
        collectionsRequired: "Veuillez sélectionner au moins une collection",
        productsRequired: "Veuillez sélectionner au moins un produit",
      ...
      success: {
        ...
        viewShopify: "Voir sur Shopify",
        view: "Voir",
      },
      loading: {
        creatingLanding: "Création de votre landing page artistique...",
        creatingShopify: "Création de la page Shopify...",
        generatingSummary: "Génération du résumé de la boutique...",
      },
    },
    blog: {
