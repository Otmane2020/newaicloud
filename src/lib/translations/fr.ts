export const translations = {
  ...
  seoAuditDashboard: {
    ...
    categoryDescriptions: {
      ...
      pages: "Optimisation des pages statiques",
      articles: "Optimisation des articles de blog",
      tags: "Score des tags produits",
    },
    homepageSection: {
    ...
    synthesis: {
      ...
      noPriority: "Aucune priorité urgente détectée ✓",
      continueEfforts: "Continuez vos efforts d'optimisation",
      productsOptimized: "Produits bien optimisés",
      collectionsOptimized: "Collections performantes",
      imagesOptimized: "Images correctement décrites",
      articlesOptimized: "Articles bien structurés",
      homepageLabel: "Page d'accueil",
      productPages: "Fiches produits",
      imagesAltText: "Images (alt text)",
      collectionsLabel: "Collections",
      optimize: "Optimiser",
    },
    quickWins: {
      title: "Quick Wins ⚡ - Actions Rapides à Fort Impact",
      subtitle: "{{count}} opportunités d'amélioration immédiate",
      actions: "actions",
      notAvailable: "Quick Wins non disponibles",
      notAvailableDesc: "Cette fonctionnalité nécessite un nouvel audit. Régénérez votre audit pour découvrir les actions rapides qui auront le plus d'impact sur votre SEO.",
      generatingAudit: "Génération en cours...",
      generateNewAudit: "Générer un nouvel audit",
    ...
    badges: {
      uniquePage: "Page unique",
      products: "produits",
    },
    buttons: {
      viewQuickWins: "Voir les Quick Wins",
      fullActionPlan: "Plan d'Action Complet",
    },
  },
  ...
  seoAuditReports: {
    ...
    loading: {
      title: "Création de votre Audit SEO",
      subtitle: "Analyse de l'ensemble de votre boutique Shopify...",
      steps: {
        ...
        collections: "Examen des collections...",
        articles: "Analyse des articles de blog...",
    ...
    globalScore: {
      title: "Score SEO Global",
      evaluationBased: "Évaluation globale basée sur 6 catégories d'audit",
      excellent: "Excellent travail !",
      good: "Bon niveau SEO",
      needsImprovement: "Améliorations nécessaires",
      urgent: "Optimisation urgente requise",
    },
    detailedAudit: {
      title: "Audit détaillé par catégorie",
      description: "Analyse approfondie de chaque aspect SEO",
    },
    categories: {
      titleQuality: "Qualité des titres SEO",
      descriptionQuality: "Qualité des meta descriptions",
      ...
      tags: "Tags",
      pageImported: "Page importée",
      pageNotImported: "Page non importée",
      shopifySync: "Synchronisation Shopify et optimisations techniques",
    },
    recommendations: {
      title: "Recommandations prioritaires",
      description: "Actions à prendre pour améliorer votre SEO",
      urgent: "URGENT",
      important: "IMPORTANT",
      improvement: "AMÉLIORATION",
      excellentWork: "Excellent travail ! 🎉",
      excellentDesc: "Votre optimisation SEO est au top. Continuez à maintenir ce niveau d'excellence.",
      homepageMissing: "Page d'accueil SEO manquante ou non optimisée (impact élevé)",
      criticalAlt: "images avec ALT text critique",
      problematicTitles: "produits avec titres SEO problématiques",
      problematicDescs: "produits avec descriptions SEO problématiques",
      contentToImprove: "Qualité du contenu à améliorer (descriptions, tags)",
      optimizeTitles: "Optimiser les titres SEO",
      improveDescs: "Améliorer les descriptions SEO",
      enrichAlts: "Enrichir les ALT texts",
    },
    detailedIssues: {
      title: "Détails des problèmes détectés",
      description: "Cliquez pour voir les problèmes spécifiques par catégorie",
      titleIssues: "Problèmes de titres SEO",
      descIssues: "Problèmes de meta descriptions",
      altIssues: "Problèmes de textes ALT",
      currentTitle: "Titre actuel",
      chars: "car.",
      andMore: "... et {{count}} autres problèmes",
    },
    scoreBadge: {
      excellent: "Excellent",
      good: "Bon",
    ...
    campaignWizard: {
      ...
      steps: {
        basicInfo: {
          ...
          subtitle: "Commençons par nommer votre campagne",
        },
        topicKeywords: {
          title: "Sujet et Mots-clés",
          subtitle: "Définissez le thème et les mots-clés SEO",
        },
        audience: {
          title: "Audience Cible",
          subtitle: "À qui s'adressent vos articles ?",
        },
        scheduling: {
          title: "Planification",
          subtitle: "Configurez le rythme de publication",
        },
      },
      fields: {
        campaignName: "Nom de la campagne *",
        ...
        mainTopicHint: "Le thème général des articles à générer",
        keywords: "SEO Keywords",
        keywordsPlaceholder: "Saisissez un mot-clé...",
        keywordsHint: "Ajoutez des mots-clés pertinents pour votre campagne",
        addKeyword: "Ajouter",
      ...
      toasts: {
        ...
        enterMainTopic: "Veuillez définir le sujet principal",
        notAuthenticated: "Non authentifié",
        campaignLimitReached: "Limite de campagnes atteinte",
        upgradeRequired: "Passez à un plan payant pour créer des campagnes.",
        monthlyLimitReached: "Limite mensuelle atteinte.",
        campaignCreated: "Campagne créée avec succès !",
        creationError: "Erreur lors de la création de la campagne",
      },
