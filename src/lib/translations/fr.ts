export const translations = {
  ...
  pricing: {
    ...
    messages: {
      ...
      pricesSynced: "Prix synchronisés vers Shopify",
  ...
  merchant: {
    ...
    actions: {
      openMerchant: "Ouvrir Merchant Center",
      generateFeed: "Générer Flux",
      downloadFeed: "Télécharger Flux",
      sync: "Synchroniser",
    },
    feedDescription: "Votre flux XML Google Merchant",
    settingsDescription: "Configurez les paramètres de votre flux",
    syncDescription: "Synchroniser avec Google Shopping",
  },
  ...
  forms: {
    ...
    placeholders: {
      ...
      addTags: "Ajouter tags...",
    },
    validation: {
      required: "Ce champ est requis",
      minLength: "Longueur minimum de {{min}} caractères",
      maxLength: "Longueur maximum de {{max}} caractères",
      invalidEmail: "Adresse email invalide",
  ...
  dialogs: {
    ...
    trialLimit: {
      ...
      message: "Vous avez atteint votre limite d'essai. Passez à un plan payant pour continuer.",
    },
    upgrade: {
      upgradeNow: "Passer à un Plan Payant",
      seePlans: "Voir les Plans",
      feature1: "Optimisations illimitées",
      feature2: "Support prioritaire",
      feature3: "Analytics avancés",
      feature4: "Intégration personnalisée",
      feature5: "Accès API",
      feature6: "Marque blanche",
      feature7: "Gestionnaire de compte dédié",
      feature8: "Garantie SLA",
    },
    limit: {
      title: "Limite Atteinte",
      description: "Vous avez atteint la limite de votre plan",
    },
  },
