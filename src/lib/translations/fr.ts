export const translations = {
  ...
  dialogs: {
    autoOptimization: {
      ...
      alertDescription: "Sélectionnez les actions que vous souhaitez effectuer. Le système optimisera automatiquement tous les éléments concernés.",
      actions: {
        products: { label: "Optimiser les produits", description: "Génération de titres et descriptions SEO" },
        collections: { label: "Optimiser les collections", description: "Enrichissement SEO des collections" },
        altTexts: { label: "Générer les ALT texts", description: "Textes alternatifs pour les images" },
        articles: { label: "Optimiser les articles", description: "SEO pour le blog" },
        pages: { label: "Optimiser les pages", description: "SEO pour les pages statiques" },
      },
      priority: { high: "Priorité Haute", medium: "Priorité Moyenne", low: "Priorité Basse" },
      elements: "élément",
      elementsPlural: "éléments",
      actionsSelected: "action sélectionnée",
      actionsSelectedPlural: "actions sélectionnées",
      itemsToProcess: "sera traité",
      itemsToProcessPlural: "seront traités",
      ...
      itemsOptimized: "élément a été optimisé",
      itemsOptimizedPlural: "éléments ont été optimisés",
      optimized: "optimisé",
    ...
    smartBackground: {
      title: "Génération de Fonds AI",
      noProductSelected: "Aucun produit sélectionné",
      format: "Format",
      mode: "Mode",
      modeWhiteShopping: "Fond blanc shopping",
      modeSmartSerp: "Smart SERP",
      mode3dShopping: "3D Shopping",
      mode3dGenerate: "3D Génération",
      style: "Style",
      styleShopping: "Shopping",
      styleLifestyle: "Lifestyle",
      styleModern: "Moderne",
      styleLivingRoom: "Salon",
      styleStudio: "Studio",
      styleNature: "Nature",
      selectImage: "Sélectionner l'image source",
  ...
  dialogs: {
    ...
    bulkLanding: {
      title: "Génération Bulk de Landing Pages",
      generating: "Génération en cours... {{current}}/{{total}}",
      generated: "{{count}} landing page(s) générée(s) sur {{total}}",
      success: "{{count}} landing page(s) générée(s) avec succès",
      cancelled: "Génération annulée",
      noneToSync: "Aucune landing page à synchroniser",
      syncError: "Erreur lors de la synchronisation",
      ...
      syncToShopify: "Synchroniser avec Shopify",
      retry: "Réessayer",
      previewTitle: "Aperçu de la landing page",
    },
    autoSync: {
      title: "Synchronisation automatique",
      storeName: "Votre boutique Shopify",
