export const translations = {
  ...
  dialogs: {
    autoOptimization: {
      ...
      selectActions: "Select optimizations to perform",
      processing: "Optimization in progress...",
      complete: "Optimization complete!",
      alertDescription: "Select the actions you want to perform. The system will automatically optimize all related items.",
      actions: {
        products: { label: "Optimize products", description: "Generate SEO titles and descriptions" },
        collections: { label: "Optimize collections", description: "SEO enrichment for collections" },
        altTexts: { label: "Generate ALT texts", description: "Alternative texts for images" },
        articles: { label: "Optimize articles", description: "SEO for blog" },
        pages: { label: "Optimize pages", description: "SEO for static pages" },
      },
      priority: { high: "High Priority", medium: "Medium Priority", low: "Low Priority" },
      elements: "item",
      elementsPlural: "items",
      actionsSelected: "action selected",
      actionsSelectedPlural: "actions selected",
      itemsToProcess: "will be processed",
      itemsToProcessPlural: "will be processed",
      ...
      itemsOptimized: "item has been optimized",
      itemsOptimizedPlural: "items have been optimized",
      optimized: "optimized",
    ...
    smartBackground: {
      ...
      format: "Format",
      mode: "Mode",
      modeWhiteShopping: "White shopping background",
      modeSmartSerp: "Smart SERP",
      mode3dShopping: "3D Shopping",
      mode3dGenerate: "3D Generation",
      style: "Style",
      styleShopping: "Shopping",
      styleLifestyle: "Lifestyle",
      styleModern: "Modern",
      styleLivingRoom: "Living room",
      styleStudio: "Studio",
      styleNature: "Nature",
  ...
  dialogs: {
    ...
    bulkLanding: {
      title: "Bulk Landing Page Generation",
      generating: "Generating... {{current}}/{{total}}",
      generated: "{{count}} landing page(s) generated out of {{total}}",
      success: "{{count}} landing page(s) generated successfully",
      cancelled: "Generation cancelled",
      noneToSync: "No landing pages to sync",
      syncError: "Error during synchronization",
      ...
      cancel: "Cancel",
      close: "Close",
      syncToShopify: "Sync with Shopify",
      retry: "Retry",
