export const translations = {
  ...
  toasts: {
    ...
    smartAI: {
      ...
      priceAppliedPromo: "Price applied as promo price",
      priceAppliedRegular: "Price applied as regular price",
      ...
      batchProgress: "Batch {{current}}/{{total}} ({{synced}}/{{totalProducts}} synchronized)",
      syncSuccessWithErrors: "{{synced}} products synchronized, {{errors}} errors",
      syncSuccess: "✅ {{count}} product(s) synchronized",
      syncError: "Error during synchronization",
      productSynced: "✅ {{title}} synchronized",
      generationFailed: "Generation failed",
      shopifySyncError: "Shopify synchronization error",
      imageRegeneratedSuccess: "Image regenerated successfully",
      regenerationFailed: "Regeneration failed",
      regenerationError: "Error during regeneration",
    ...
    collections: {
      ...
      import: {
        ...
        description:
          "Select the collections you want to import into your account. Imported collections can be used to create targeted blog articles.",
  ...
  landingGeneration: {
    ...
    preview: {
      ...
      syncSuccess: "Landing page synced with Shopify",
      syncError: "Error during synchronization",
      viewMobile: "Mobile view",
      viewDesktop: "Desktop view",
      shopifyView: "Shopify view",
      rawView: "Raw view",
      showWithoutCss: "View without Shopify CSS",
      simulateShopify: "Simulate Shopify rendering",
      loading: "Loading preview...",
      loadError: "Loading error",
      loadErrorDesc: "HTML content cannot be displayed. Check console logs.",
      retryLoad: "Retry",
      noLandingPage: "No landing page available",
      noLandingPageDesc: "Create an optimized landing page for this product and preview it instantly",
      generateMyLanding: "Generate my Landing Page",
      generationTakes: "Generation takes a few seconds",
      generationInProgress: "Landing page generation in progress...",
      pleaseWait: "Please wait a moment.",
      viewOnline: "View online",
      configRequired: "Configuration required:",
      configRequiredDesc:
        "For your landing pages to display correctly on Shopify, you must add custom CSS to your theme.",
      seeGuide: "See guide",
    ...
    // Progress messages
    progressMessages: {
      resolvingVendor: "Resolving vendor...",
      optimizingTitle: "Optimizing SERP title...",
      analyzingImages: "Analyzing images with Vision AI...",
      generatingHtml: "Generating HTML content...",
      finalizingHtml: "Finalizing HTML...",
      titleOptimized: "Title optimized: {{title}}",
      titleBasedOnVision: "Title based on product visual analysis",
    },

    // Fallback mode
    fallback: {
      partialGeneration: "Partial generation",
      partialGenerationDesc: "Complete generation failed. A basic template has been created.",
      retryFastMode: "Retry in fast mode",
      simplifiedMode: "⚡ Landing page generated in simplified mode",
    },

    // Timeouts
    timeout: {
      tooLong: "Generation took too long. Try with shorter content or fast mode.",
      timeoutError: "Timeout: generation too long",
      timeoutDesc: "Try selecting 'Short content' or disable secondary analyses",
    },
  },
  ...
  aiAssistant: {
    ...
    contactFormDescription: "Prefer to reach us by email? Fill out this form.",
    yourName: "Your name",
    yourEmail: "Your email",
    yourMessage: "Your message",
    sendContact: "Send",
    contactSent: "Message sent!",
    contactSentDescription: "We will get back to you as soon as possible.",
    contactError: "Error sending. Please try again.",
    showContactForm: "📧 Send an email",
    hideContactForm: "💬 Back to chat",
  },
  notFound: {
  ...
  navigation: {
    ...
    dashboard: "Dashboard",
    products: "Products",
    productOptimization: "Product Catalogue",
  ...
  superAdmin: {
    ...
    videoAds: {
      ...
      description: "Create professional video ads for NEWAI",
      clipLibrary: {
        title: "Screen Recordings",
        upload: "Upload Video",
        noClips: "No clips yet",
        uploadFirst: "Upload your demo recordings to get started",
      },
      storyboard: {
        title: "Storyboard",
      ...
      scriptGenerator: {
        ...
        generating: "Generating...",
        applyToStoryboard: "Apply to Storyboard",
      },
      export: {
        button: "Export Video",
        exporting: "Exporting...",
      ...
      toasts: {
        clipUploaded: "Clip uploaded successfully",
        clipDeleted: "Clip deleted",
        scriptGenerated: "Script generated by AI",
      },
    },
    googleAds: {
      ...
      last30Days: "Last 30 days",
      costVsRevenue: "Cost vs Revenue",
      dailyComparison: "Daily comparison",
      noData: "No data available",
      searchTermsReport: "Search Terms Report",
      searchTermsDesc: "All search queries triggering your ads",
      importSearchTerms: "Import",
      term: "Term",
      campaign: "Campaign",
      noSearchTerms: "No search terms yet",
      importToStart: "Import your Google Ads data to get started",
      importNow: "Import Now",
      negativeKeywords: "Negative Keywords",
      negativesDesc: "AI-suggested keywords to exclude",
      generateNegatives: "Generate with AI",
      applied: "Applied",
      pending: "Pending",
      noNegatives: "No negative keywords yet",
      aiWillAnalyze: "AI will analyze your search terms to find irrelevant queries",
      analyzeNow: "Analyze Now",
      suggestedKeywords: "Suggested Keywords",
      keywordsDesc: "High-potential keywords to add to campaigns",
      added: "Added",
      suggested: "Suggested",
      noSuggestions: "No suggestions yet",
      importFirst: "Import search terms first to get AI keyword suggestions",
      aiStrategy: "AI Strategy Engine",
      strategyDesc: "Personalized optimization recommendations",
      generateStrategy: "Generate Strategy",
      potentialImpact: "potential impact",
      noStrategy: "No strategy generated yet",
      aiWillCreate: "AI will analyze your campaigns and create personalized recommendations",
      startAnalysis: "Start Analysis",
      importSuccess: "Import successful",
      searchTermsImported: "Search terms imported",
      negativesGenerated: "Negatives generated",
      reviewSuggestions: "Review the suggestions below",
      strategyGenerated: "Strategy generated",
      aiAnalysisComplete: "AI analysis complete",
    },
    translationScanner: {
      title: "AI Translation Scanner",
      description: "Select a file to scan or paste code manually",
      tabs: {
        batch: "🚀 Batch",
        files: "Files",
        analyze: "Analyze",
      ...
      autoScan: {
        title: "🚀 Automatic Translation Scanner",
        description: "Automatic scanner that reads files DIRECTLY from GitHub - no copy-paste needed!",
        infoTitle: "✨ 100% Automatic Scan",
        features: [
          "Reads files directly from your GitHub repo",
          "Automatic AI analysis (Gemini)",
          "Detects: toasts, dialogs, alerts, props, JSX text",
          "Automatically generates FR and EN translations",
          "Download fr.ts and en.ts files in one click",
        ],
        scanButton: "🔍 Scan Entire Project (GitHub)",
        scanning: "Scanning...",
        scanningHelp: "Reading files from GitHub and AI analysis... This may take 1-2 minutes.",
      },
      results: {
      ...
      addTranslations: {
        title: "🎯 Automatically add translations",
        description: "{{count}} translations detected. Copy the code below and add it to your translation files.",
        frTranslations: "🇫🇷 FR Translations",
        enTranslations: "🇬🇧 EN Translations",
        copy: "Copy",
        downloadComplete: "📥 Download Complete Files",
        copyFrComplete: "Copy complete fr.ts",
        copyEnComplete: "Copy complete en.ts",
      },
      error: {
        ...
        githubFix: {
          title: "🔧 How to fix GitHub credentials",
          step1: "Go to Settings → Secrets of this Lovable project",
          step2: "Update GITHUB_TOKEN with a token that has repo access",
          step3: "Verify GITHUB_OWNER (e.g., \"yourorganization\")",
          step4: "Verify GITHUB_REPO (e.g., \"your-project\")",
          tokenPermission: "The token must have repo (read) permissions on the target repository.",
        },
        alternativeTitle: "✅ Alternative: Manual Mode (always works)",
        alternativeDesc: "Paste the code directly below to analyze it without GitHub.",
        analyzeCode: "🔍 Analyze this code",
      },
      manual: {
        title: "📝 Manual Mode (copy-paste)",
        description: "Alternative if GitHub doesn't work - paste the code directly to analyze",
        pasteCode: "Paste code manually",
        placeholder: "Paste here the code of one or more TSX/TS files...",
      ...
      globalScan: {
        title: "Global Project Scanner",
        filesRegistered: "{{count}} files registered",
        basedOnHistory: "Analysis based on scan history",
  ...
  account: {
    ...
    billing: {
      ...
      trialPeriodUntil: "Trial period until {{date}}",
      planFullyActivated: "Your full plan is activated and all services are available",
      trialWarning: "You are in trial period. Activate your paid plan to continue after the trial.",
      setupPayment: "Setup payment",
      setupPaymentDesc: "Configure your payment method to access billing",
      activateSubscription: "Activate my paid subscription",
      activateDesc: "Activate your plan to continue using all services",
      managePaymentMethods: "Manage your payment methods and view invoices",
      portalButton: "Billing",
    },
    subscription: {
      ...
      usedPercentage: "You have used {{percent}}% of your optimizations.",
      switchToPlan: "Switch to {{count}} optimizations",
    },
  },
  ...
  seo: {
    ...
    altImage: {
      ...
      banner: {
        ...
        description:
          "Automatically generate optimized ALT descriptions for your images. Improve accessibility and SEO by 35%.",
  ...
  blog: {
    ...
    aiArticle: {
      ...
      quickPress: {
        ...
        description:
          "Our intelligent assistant guides you step by step: collection selection, layout choice, color customization, product selection, and generation of a complete article with images, table of contents and interactive galleries.",
      },
      features: {
        design: {
    ...
    articleGeneration: {
      ...
      steps: {
        ...
        integratingKeywords: "🔍 Integrating SEO keywords",
        creatingContent: "✨ Creating content with AI",
        applyingDesign: "🎨 Applying design and colors",
        generatingGalleries: "🖼️ Generating image galleries",
        creatingLinks: "🔗 Creating Shopify links",
        finalizing: "✅ Finalizing blog article",
    ...
    dialogs: {
      featuredImage: {
        ...
        syncingToShopify: "Syncing image with Shopify...",
        optimizeNowTitle: "Optimize now with Vision AI!",
        optimizedAltText: "AI-generated optimized ALT text",
        autoSync: "Automatic synchronization with your Shopify store",
        improvedSeo: "Improved SEO for better ranking",
        optimizeAlt: "Optimize ALT text",
        generatingAlt: "Generating ALT...",
        publishToShopify: "Publish to Shopify",
        syncing: "Syncing...",
        close: "Close",
      },
      ...
      aiOpportunities: {
        ...
        titlePlatform: "{{platform}} Opportunities",
        description: "Articles optimized to be cited by AI",
        analyzing: "Analyzing AI opportunities...",
        refreshed: "{{count}} opportunities generated",
        noOpportunities: "No opportunities detected. Generate new ones!",
        generate: "Generate opportunities",
        aeoTitle: "Answer Engine Optimization (AEO)",
        aeoDescription: "Create articles optimized to be cited by {{platform}} in its responses",
        userAsks: "User asks:",
        suggestedTitle: "Suggested title",
        citationPotential: "Citation potential",
        generateAeoArticle: "Generate AEO article",
        queryTypes: {
  ...
  collections: {
    ...
    noCollections: "No collections found",
    noStoreSelected: "No store selected",
    selectStoreDescription: "Please select a store from the menu above to view collections.",
    reoptimizeAll: "Re-optimize all",
    empty: {
    ...
    optimization: {
      ...
      messages: {
        ...
        collectionsOptimizedCount: "✅ {{count}} collection(s) optimized",
        syncedToShopify: "✅ {{count}} collection(s) synced with Shopify",
  ...
  auth: {
    ...
    registrationSuccess: "Registration successful! Free access activated.",
  ...
  googleSearchConsole: {
    ...
    connect: {
      title: "Google Search Console",
      description:
        "Connect your Google account to import Search Console data and track your traffic evolution and SEO optimization impact.",
      connectWithGoogle: "Connect with Google",
  ...
  dialogsLegacy: {
    ...
    gsc: {
      ...
      disconnect: {
        ...
        description:
          "Are you sure you want to disconnect your Google Search Console account? You will lose access to SEO performance data.",
        cancel: "Cancel",
        confirm: "Disconnect",
      },
    },
    ...
    productMedia: {
      ...
      description:
        "Select your preferred variant. Each image is generated at 2000x2000px with the product perfectly centered.",
    },
    // Sync Results Dialog
    syncResults: {
  ...
  homepageAudit: {
    ...
    aiOptimizationNote:
      "AI optimization automatically generates title and description, then saves and syncs them with Shopify",
    sections: {
    ...
    recommendations: {
      ...
      enrichContent:
        "Enrich your homepage with at least 300 words of unique content describing your products and values",
    ...
    sync: {
      ...
      autoExport: {
        ...
        afterOptimizationDesc:
          "Automatically sync to Shopify after AI optimization without confirmation (skip all pop-ups)",
      },
      badges: {
        default: "Default",
        advanced: "Advanced",
    ...
    store: {
      metadata: {
        ...
        hints: {
          ...
          domain: "Your custom domain (without https://)",
        },
  ...
  adminShopifyWebhooks: {
    title: "Shopify Webhooks Diagnostic",
    description: "Check and repair mandatory GDPR webhooks",
    important: "Important",
    shopifyRequires: "Shopify requires 3 mandatory GDPR webhooks for app approval:",
    webhookTopics: {
      customersDataRequest: "Customer data request",
      customersRedact: "Customer data deletion",
      shopRedact: "Shop data deletion",
    },
    noStoresConnected: "No stores connected",
    connectStore: "Connect a store",
    gdprWebhooks: "GDPR Webhooks:",
    totalWebhooksRegistered: "Total webhooks registered:",
    incorrectUrl: "(incorrect URL)",
    notRegistered: "Not registered",
    buttons: {
      check: "Check",
      repair: "Repair / Create webhooks",
      recreateAll: "Recreate all",
    },
    status: {
      ok: "OK",
      problem: "Problem",
    ...
    toasts: {
      ...
      checkError: "Error checking webhooks",
      allConfigured: "All GDPR webhooks are correctly configured",
      someMissing: "Some GDPR webhooks are missing or misconfigured",
      registerSuccess: "GDPR webhooks registered successfully",
      registerPartial: "Some webhooks could not be created",
      registerError: "Error registering webhooks",
    },
  },

  // ============= Admin GDPR Webhook Test =============
  adminGdprWebhookTest: {
    title: "GDPR Webhook HMAC Test",
    description: "Test the HMAC validation of your mandatory GDPR webhooks for Shopify",
    mandatoryWebhooks: "Mandatory GDPR Webhooks",
    shopifyRequires: "Shopify requires the implementation of 3 GDPR webhooks with HMAC validation",
    webhookTopics: {
      customersDataRequest: "Customer data request",
      customersRedact: "Customer data deletion",
      shopRedact: "Shop data deletion",
    ...
    test1: {
      title: "Test 1: HMAC Validation",
      description: "Tests HMAC validation with complete Shopify headers (real webhooks)",
      button: "Test HMAC validation",
      running: "Testing...",
    },
    test2: {
      title: "Test 2: Shopify Verification",
      description: "Simulates Shopify's automatic verification (no HMAC, accepted since 2025)",
      button: "Test verification",
      running: "Testing...",
    },
    results: {
      hmacTitle: "HMAC Test Result",
      verificationTitle: "Shopify Verification Result",
      status: "Status",
  ...
  landing: {
    ...
    howItWorks: {
      ...
      title: "How It Works",
      subtitle: "From invisible to ranking in 4 simple steps",
      steps: [
        {
          title: "Install",
        ...
        },
        {
          ...
          description: "Our AI analyzes all your products instantly",
        },
        {
          title: "SEO is Fixed Automatically",
          description: "Titles, meta, images, feeds — all optimized",
        },
        {
          title: "Google Traffic Increases",
          description: "Watch your rankings climb within days",
        },
      ],
    },
    features: {
    ...
    pricing: {
      ...
      title: "Start Free. Upgrade When You See Results.",
      subtitle:
        "No commitment. Cancel anytime. See your traffic grow before you pay.",
      monthly: "Monthly",
      yearly: "Yearly",
      yearlyDiscount: "-20%",
      perMonth: "/month",
  ...
  seoAuditDashboard: {
    ...
    actionsSection: {
      title: "SEO Action Plan",
      subtitle: "Follow these {{count}} priority steps to improve your SEO ranking",
      status: "Status",
      pending: "To do",
      inProgress: "In progress",
      completed: "Completed",
      ...
      needHelp: "Need help optimizing?",
      aiCanHelp: "Our AI can help you apply these recommendations automatically",
      optimizeAuto: "Optimize Automatically",
    },
    synthesis: {
      title: "Summary and Priority Actions",
      subtitle: "Recommendations based on your SEO analysis",
      strengths: "Strengths",
      improvementPriorities: "Improvement Priorities",
      productsOptimized: "Products well optimized ({{optimized}}/{{total}})",
      collectionsOptimized: "High-performing collections ({{optimized}}/{{total}})",
      imagesOptimized: "Images properly described ({{optimized}}/{{total}})",
      articlesOptimized: "Well-structured articles ({{optimized}}/{{total}})",
      continueEfforts: "Continue your optimization efforts",
      homepage: "Homepage",
      productSheets: "Product sheets",
      imagesAltText: "Images (alt text)",
      collections: "Collections",
      optimizeItem: "Optimize {{item}}",
      noPriorityDetected: "No urgent priority detected ✓",
      viewQuickWins: "View Quick Wins",
      completeActionPlan: "Complete Action Plan",
    },
    categoryLabels: {
      homepage: "Homepage",
      products: "Products",
      ...
      images: "Images",
      tags: "Tags",
      homepageDesc: "Optimization of your homepage",
      productsDesc: "Optimization of your product pages",
      collectionsDesc: "Optimization of your collections",
      pagesDesc: "Optimization of your static pages",
      articlesDesc: "Optimization of your articles",
      imagesDesc: "Alt texts for your images",
      tagsDesc: "Tags for your products",
    },
  },
  ...
  seoAuditReports: {
    ...
    important: "IMPORTANT",
    improvement: "IMPROVEMENT",
    homepageMissing: "Homepage SEO missing or not optimized (high impact)",
    imagesCriticalAlt: "{{count}} images with critical ALT text",
    productsProblematicTitles: "{{count}} products with problematic SEO titles",
    productsProblematicDescs: "{{count}} products with problematic SEO descriptions",
    contentToImprove: "Content quality to improve (descriptions, tags)",
    optimizeTitles: "Optimize {{count}} SEO titles",
    improveDescs: "Improve {{count}} SEO descriptions",
  ...
  dialogs: {
    ...
    generateDescription: {
      ...
      saving: "Saving...",
      close: "Close",
      placeholder: "Click the button below to automatically generate an optimized description for this collection.",
      success: "Description generated successfully",
      saved: "Description saved",
      limitReached: "Limit reached",
      limitDesc: "You have reached your optimization limit",
      error: "Error during generation",
      saveError: "Error saving description",
      noDescription: "No description generated",
    },
    autoOptimization: {
      title: "Automatic Optimization",
      subtitle: "Select actions to execute",
      selectActions: "Select the optimizations to perform",
      alertDesc: "Select the actions you want to perform. The system will automatically optimize all related items.",
      optimizeProducts: "Optimize products",
      optimizeProductsDesc: "Generate SEO titles and descriptions",
      optimizeCollections: "Optimize collections",
      optimizeCollectionsDesc: "SEO enrichment for collections",
      generateAltTexts: "Generate ALT texts",
      generateAltTextsDesc: "Alternative text for images",
      optimizeArticles: "Optimize articles",
      optimizeArticlesDesc: "SEO for blog posts",
      optimizePages: "Optimize pages",
      optimizePagesDesc: "SEO for static pages",
      generateTags: "Generate tags",
      generateTagsDesc: "Automatic tags for products",
      // Priority labels
      priorityHigh: "High Priority",
      priorityMedium: "Medium Priority",
      priorityLow: "Low Priority",
      ...
      willBeProcessedPlural: "will be processed",
      // Progress
      inProgress: "Optimization in progress",
      optimizingProducts: "Optimizing products...",
      optimizingCollections: "Optimizing collections...",
      generatingAltTexts: "Generating ALT texts...",
      optimizingArticles: "Optimizing articles...",
      optimizingPages: "Optimizing pages...",
      progressLabel: "Progress",
      // Results
      optimized: "optimized",
      optimizedPlural: "optimized",
      hasBeenOptimized: "has been optimized",
      haveBeenOptimized: "have been optimized",
      optimizationError: "Error during optimization",
      ...
      success: "Success",
      errors: "Errors",
      selected: "{{count}} action(s) selected",
      totalItems: "{{count}} item(s) to process",
      startOptimization: "Start optimization",
    },
    bulkLanding: {
      title: "Bulk Landing Page Generation",
      generating: "Generating... {{current}}/{{total}}",
      generated: "{{success}} landing page(s) generated out of {{total}}",
      processed: "processed",
      pending: "Pending",
      ...
      success: "{{count}} landing page(s) generated successfully",
      cancelled: "Generation cancelled",
      noneToSync: "No landing pages to sync",
      syncing: "Syncing {{count}} product(s) to Shopify...",
      synced: "{{count}} product(s) synced with Shopify",
      syncError: "Error during synchronization",
    ...
    createPost: {
      ...
      facebookCredits: "Facebook (3 credits)",
      instagramCredits: "Instagram (3 credits)",
      includeProductLink: "Include link to product/article",
      cancel: "Cancel",
      createPost: "Create post",
      selectContentFirst: "Select content first",
      addCaptionAndContent: "Select content and add a caption",
    ...
    smartBackground: {
      ...
      description: "Generate professional backgrounds with Google SERP",
      noProductSelected: "No product selected",
      outputFormat: "Output format",
      chooseFormat: "Choose format",
      square: "Square (1:1) - Google Shopping",
      landscape43: "Landscape (4:3)",
      portrait34: "Portrait (3:4)",
      cinema: "Cinema (16:9) - Banners",
      ...
      threeDGenerate: "3D Generate - Recreate product in 3D",
      whiteDesc: "Pure white background with SERP + Vision AI, studio lighting, 3D effect, Google Merchant Center compliant",
      threeDShoppingDesc: "Realistic 3D product on white 1:1 background, professional studio lighting, Google Shopping compliant",
      smartSerpDesc: "SERP enrichment (dimensions, materials), Vision AI, professional 3D effect",
      threeDGenerateDesc: "Complete 3D recreation of product with realistic modeling and new background",
      backgroundStyle: "Background style",
      styles: {
        shopping: "Shopping",
        shoppingDesc: "Professional e-commerce",
        lifestyle: "Lifestyle",
        lifestyleDesc: "Natural atmosphere",
        moderne: "Modern",
        moderneDesc: "Clean design",
        livingRoom: "Living Room",
        livingRoomDesc: "Cozy interior",
        studio: "Studio",
        studioDesc: "Studio lighting",
        nature: "Nature",
        natureDesc: "Natural outdoor",
      },
      styleDescriptions: {
        shopping: "E-commerce optimized neutral background, product enhancement",
        lifestyle: "Realistic living context, warm atmosphere",
        moderne: "Clean lines, minimalist contemporary design",
        livingRoom: "Living room/house interior decor, home context",
        studio: "Professional photo studio lighting",
        nature: "Natural outdoor environment, greenery",
      },
      ...
      failed: "Failed",
      cancel: "Cancel",
      cancelGeneration: "Cancelling...",
      generateAll: "Generate all ({{count}})",
      applyAll: "Apply all",
      applying: "Applying...",
      close: "Close",
      backgroundsGenerated: "{{count}} background(s) generated",
      backgroundsApplied: "{{count}} background(s) applied",
      appliedDescription: "Images have been updated and synced with Shopify.",
      noImageApplied: "No image could be applied",
      checkGeneration: "Check that images were generated correctly.",
      generationCancelled: "Generation cancelled",
      historyApplied: "History image applied",
    ...
    upgrade: {
      ...
      planUpgraded: "Plan upgraded successfully!",
      finalizePayment: "Please finalize payment to activate your new plan.",
      planUpgradedNewCycle: "✅ Plan upgraded! New cycle starts now.",
      planUpgradedNoProration: "✅ Plan upgraded! New cycle started without proration.",
      planUpgradedWithProration: "✅ Plan upgraded! {{amount}} prorated charge. Your counters have been reset.",
      planUpgradedProrationDetails:
        "✅ Plan upgraded!\n💰 Amount charged: {{amount}}{{currency}}\n📅 {{daysRemaining}}d remaining / {{totalDays}}d",
    ...
    planUpgrade: {
      ...
      updating: "Updating...",
      confirmChange: "Confirm change",
      billingDetails: "ℹ️ Billing details",
      calculatingProration: "Calculating proration...",
      cycleDay: "You are at day {{day}} of your cycle",
      daysRemaining: "{{days}} days remaining until renewal",
      estimatedProration: "Estimated proration amount: {{amount}}",
      countersReset: "Your monthly counters will be reset immediately",
      noProration: "No proration (start of cycle)",
      fullPriceCharged: "You will pay the full price of the new plan",
      renewalDate: "Renewal date: {{date}}",
      prorationBilled: "You will be billed pro-rata based on your position in the cycle",
      countersResetIfApplicable: "Your monthly counters will be reset if applicable",
      renewalDateUnchanged: "Your renewal date remains unchanged",
      changeEffectiveImmediately: "The change will be effective immediately",
      creditedForRemainingCycle: "You will be credited for the rest of the cycle",
      countersAdjusted: "Your monthly counters will be adjusted",
      maxProducts: "{{count}} products maximum",
      maxOptimizations: "{{count}} optimizations/month",
      maxArticles: "{{count}} articles/month",
      maxChatResponses: "{{count}} chat responses/month",
      perMonth: "month",
      perYear: "year",
  ...
  // ============= Shopify Connection Dialogs =============
  shopifyConnection: {
    title: "Connect a Shopify store",
    description: "Choose your connection method",
    oauthRecommended: "OAuth (Recommended)",
    apiKeys: "API Keys",
    secureOAuthConnection: "Secure OAuth Connection",
    oauthDescription: "Recommended method: quick and secure connection via OAuth",
    commercialName: "Commercial name of your store",
    commercialNamePlaceholder: "Movala, Decora Home, etc.",
    commercialNameHint: 'The name that will appear in the interface (e.g. "Movala")',
    technicalCode: "Technical code of your store",
    findInUrl: "Find the name in the URL:",
    connectWithOAuth: "Connect with OAuth",
    connecting: "Connecting...",
    newToShopify: "New to Shopify? Check the detailed guide below to create your API keys in just a few minutes.",
    connectionForm: "Connection Form",
    fillCredentials: "Fill in your API credentials",
    apiKeyLabel: "API Key (32 characters)",
    apiKeyHint: '32 hexadecimal characters found in the "API credentials" tab',
    adminApiToken: "Admin API Access Token (shpat_)",
    adminApiTokenHint: 'Starts with shpat_ - Token revealed only once in "API credentials"',
    connectWithApiKeys: "Connect with API Keys",
    enterStoreName: "Please enter your store name",
    ...
    fillAllFields: "Please fill in all fields",
    storeAlreadyConnected: "This store is already connected",
    invalidCredentials: "Invalid credentials. Please check your API Key and Admin API Access Token.",
    storeConnectedSuccess: "Store connected successfully! 🎉",
    autoSyncStarted: "Automatic sync in progress...",
    oauthError: "OAuth connection error",
    storeLimitReached: "Store limit reached",
    storeLimitDesc:
      "You have reached the maximum number of stores ({{current}}/{{max}}). Upgrade your plan to add more stores.",
    limitedPermissions: "Limited permissions detected",
    missingAccess:
      "Missing access: {{permissions}}. Some features will be disabled. Check API permissions in Shopify Admin.",
    connectYourStore: "Connect your Shopify store",
    connectStore: "Connect your store",
    apiKeysConnection: "API Keys Connection",
    oauthShopifyConnection: "Shopify OAuth Connection",
    enterShopName: "Enter your Shopify store name",
    domain: "Domain",
    continueToShopify: "Continue to Shopify",
    connectionInProgress: "Connection in progress...",
    howToGenerateApiKeys: "How to generate your API keys",
    shopName: "Store name",
    apiKey: "API Key",
    yourApiKey: "Your Shopify API key",
  ...
  // ============= Shopify Retry Claim =============
  shopifyRetryClaim: {
    noPendingConnection: "No pending Shopify connection found",
    reinstallApp: "Please reinstall the app from your Shopify Partner Dashboard.",
    authRequired: "Authentication required",
    pleaseLogin: "Please log in to continue.",
    tokenExpired: "Connection token expired",
    invalidToken: "Invalid connection token",
    failedToConnect: "Failed to connect store",
    tryAgainOrContact: "Please try again or contact support.",
    storeConnectedSuccess: "Shopify store connected successfully!",
    productsImporting: "Your products are being imported.",
    connectionFailed: "Connection failed",
    unexpectedError: "An unexpected error occurred.",
    retrying: "Connecting...",
    retryConnection: "Retry Shopify Connection",
  },
  ...
  blogWizardToasts: {
    ...
    keywordAdded: "Keyword added",
    suggestedKeywordAdded: "Suggested keyword added",
    keywordsAdded: "{{count}} keywords added",
    selectCollection: "Please select at least one collection",
    selectProduct: "Please select at least one product",
    selectProductsOrCollection: "Please select at least products or a collection",
    articleGenerated: "🎉 Article generated successfully!",
    ...
    trialLimitReached: "Trial limit reached",
    monthlyLimitReached: "Monthly limit reached",
    articleLimitReached: "Article limit reached",
    articleLimitDesc: "You have used {{used}}/{{max}} articles.",
    userNotConnected: "User not connected or store not selected",
  },
  ...
  adminComponents: {
    ...
    analytics: {
      title: "Analytics by Plan",
      description: "Overview of statistics by subscription plan",
      users: "Users",
      active: "Active",
      trialing: "In trial",
      stores: "Stores",
      products: "Products",
      avgProductsPerUser: "Avg products/user",
      clientDetails: "Client Details",
      clientDetailsDesc: "Detailed view of users filtered by plan",
      filterByPlan: "Filter by plan",
      allPlans: "All plans",
      noPlan: "No plan",
      email: "Email",
      ...
      status: "Status",
      plan: "Plan",
      productsQuota: "Products (Quota)",
      optimizationsQuota: "Optimizations (Quota)",
    ...
    userInsight: {
      selectUser: "Please select a user to view insights",
      ...
      lowRisk: "Low risk - User is highly engaged",
      mediumRisk: "Medium risk - Monitor activity",
  ...
  noStorePrompt: {
    ...
    description: "Connect your Shopify store to start optimizing your products and improve your SEO.",
    connectButton: "Connect a store",
  },

  // ============= Smart Title =============
  smartTitle: {
    title: "Smart Title Generator",
    productsWithImages: "{{count}} products with images",
    description:
      "Intelligent title generation combining visual analysis (Gemini Vision) and textual analysis (DeepSeek)",
    previewGenerated: "Optimized title preview generated!",
    generationError: "Error generating preview",
    titleApplied: "Optimized title applied successfully!",
    applyError: "Error applying title",
    currentTitle: "Current title",
    optimizedTitle: "Proposed optimized title",
    visionAnalysis: "Gemini Visual Analysis",
    textAnalysis: "DeepSeek Textual Analysis",
    category: "Category",
    style: "Style",
    materials: "Materials",
    features: "Features",
  ...
  netlinking: {
    ...
    tooltips: {
      ...
      verified: "Verified",
      httpCode: "HTTP Code",
      notVerified: "This link has not been verified yet",
      replace: "Replace",
      recheck: "Re-check",
      delete: "Delete",
      check: "Check",
    ...
    generation: {
      title: "Generate Articles with Netlinking",
      description: "Automatically create optimized articles with internal links based on your catalog",
      analyzingCatalog: "Analyzing catalog...",
      analyzingPages: "Analyzing Shopify pages...",
      articlesGenerated: "Articles generated with automatic netlinking!",
      articlesGeneratedPages: "Articles generated for pages!",
      generateForProducts: "Generate article for related products",
      generateForPages: "Generate article for Shopify pages",
      aiNote: "AI will analyze your catalog and create articles with automatic internal links",
  ...
  campaignWizard: {
    steps: {
      basicInfo: {
        ...
        description: "Let's start by naming your campaign",
      },
      topicKeywords: {
        title: "Topic & Keywords",
        description: "Define the theme and SEO keywords",
      },
      targetAudience: {
        title: "Target Audience",
        description: "Who are your articles for?",
      },
      scheduling: {
        title: "Scheduling",
    ...
    placeholders: {
      ...
      description: "Describe the objective of this campaign...",
      mainTopic: "Ex: Scandinavian furniture, Modern decoration...",
    ...
    audiences: {
      ...
      families: "Families",
      all: "All audiences",
      selectPlaceholder: "Select your audience",
    },
    frequencies: {
      daily: "Daily",
      weekly: "Weekly",
    ...
    toasts: {
      ...
      campaignLimitReached: "Campaign limit reached",
      upgradeForCampaigns: "Upgrade to a paid plan to create campaigns.",
      monthlyLimitReached: "Monthly limit reached.",
      campaignCreated: "Campaign created successfully!",
      creationError: "Error creating campaign",
      notAuthenticated: "Not authenticated",
  ...
  blogWizardExtended: {
    editorialAngle: {
      ...
      comparisonDesc: "Product comparison",
      review: "⭐ Review",
      reviewDesc: "Tests and reviews",
      tutorial: "🎓 Tutorial",
      tutorialDesc: "Practical guide",
    },
    targetAudience: {
      title: "Target audience",
      beginner: "👶 Beginner",
    ...
    collections: {
      title: "Collections",
      searchPlaceholder: "Search for a collection...",
      noCollections: "No collection found. Import your collections from Shopify first.",
      noResults: "No collection matches your search.",
      productsCount: "product(s)",
      productsInSelected: "product(s) in selected collections",
    },
    articleLength: {
      title: "Article length",
      short: "Short",
      shortWords: "~700 words",
      shortTime: "3-4 min",
      long: "Long",
      longWords: "~2000 words",
      longTime: "8-10 min",
      complete: "Complete",
      completeWords: "~4000 words",
      completeTime: "15-20 min",
    },
    products: {
      selectedCollections: "Selected collections:",
      searchPlaceholder: "Search product by name, description or category...",
      selected: "product(s) selected",
      available: "product(s) available",
      deselectAll: "Deselect all",
      noProducts: "No product found",
      noSearchResults: "No product matches your search.",
      noCollectionProducts: "No products available in selected collections.",
      selectTip: "💡 Select at least one product to generate a relevant article.",
    },
    keywords: {
      title: "Keyword management",
      description: "Add relevant keywords to optimize your article's SEO.",
      aiSuggestions: "🤖 AI Suggestions",
      selectAll: "Select all",
      selectedCount: "{{count}} selected",
      noKeywords: "No keyword added",
      addToImprove: "Add keywords to improve SEO",
      yourKeywords: "Your keywords",
      placeholder: "Add a keyword...",
    },
    generation: {
      articleGenerated: "🎉 Article generated successfully!",
      articleGeneratedDesc: "Your SEO-optimized content is ready.",
      noArticleGenerated: "No article generated",
      trialLimitReached: "Trial limit reached",
      trialLimitDesc: "Upgrade to a subscription to continue generating articles.",
      monthlyLimitReached: "Monthly limit reached",
      monthlyLimitDesc: "Your monthly quota is exhausted.",
      generationError: "Error during generation",
      articlePublished: "✅ Article published to Shopify",
  ...
  blogSeoManagement: {
    ...
    selectTopic: "Select a topic to create an article",
    ...
    slug: "Slug",
    metaDescription: "Meta Description",
    enterMetaDescription: "SEO meta description...",
    excerpt: "Excerpt",
    enterExcerpt: "Short excerpt for article cards...",
    content: "Content (HTML)",
    generateWithAI: "Generate with AI",
    enterContent: "Article content in HTML format...",
    ...
    errorLoading: "Error loading articles",
    errorGenerating: "Error generating suggestions",
    titleRequired: "Title required",
    enterTitleFirst: "Enter a title first",
    contentGenerated: "Content generated",
    reviewBeforePublish: "Review before publishing",
  ...
  socialMedia: {
    title: "Social Media",
    subtitle: "Manage your Facebook and Instagram posts automatically",
    newCampaign: "New campaign",
    ...
    settings: {
      ...
      description: "Configure your publishing preferences",
      autoPostArticles: "Auto-post articles",
      autoPostArticlesDesc: "Automatically publish new articles to social networks",
      defaultTemplate: "Default template style",
      brandColor: "Brand color",
      logoUrl: "Logo URL",
      cost: {
        title: "Publishing costs",
        facebook: "Facebook post: 3 credits",
        instagram: "Instagram post: 3 credits",
        video: "Video/Reel: 5 credits",
      },
      save: "Save",
    ...
    campaign: {
      ...
      wizard: {
        ...
        name: "Campaign name",
        namePlaceholder: "Ex: Summer Sale 2024",
        nameRequired: "Give your campaign a name",
        channelRequired: "Select at least one channel",
        contentType: "Content type to publish",
        contentTypes: {
          products: "Products (title, description, photos, variations)",
          collections: "Collections",
          articles: "Blog articles",
        },
        ...
        executionHour: "Publishing hour (UTC)",
        channels: "Publishing channels",
        next: "Next",
        nextContent: "Next - Content selection",
        back: "Back",
        create: "Create campaign",
      ...
      format: {
        title: "Post format",
        image: "Image",
        imageDesc: "Simple photo with text",
        carousel: "Carousel",
        carouselDesc: "Multi-images (all photos)",
        video: "Video",
        videoDesc: "Animated slideshow + music",
        reel: "Reel",
        reelDesc: "Vertical format 9:16",
      },
      video: {
        title: "Video options",
        music: "Background music (free)",
        selectMusic: "Select music...",
        noMusic: "No music",
        voice: "AI Voice (ElevenLabs)",
        voiceDesc: "Coming soon - Auto narration",
      },
      template: {
        title: "Visual style",
        simple: "Simple photo",
        overlay: "Template with text overlay",
      ...
      options: {
        ...
        includeLogoDesc: "Add your logo to visuals",
        includeLink: "Include link",
        includeLinkDesc: "Add a link to the product/article",
        customPrompt: "Custom instructions (optional)",
        customPromptPlaceholder: "Ex: Use a casual tone, add emojis...",
      },
      content: {
        productsTitle: "Products to promote (optional)",
        productsDesc: "Leave empty for automatic rotation of all your products",
        collectionsTitle: "Collections to promote (optional)",
        articlesDesc: "Published articles will be automatically shared",
  ...
  creativeStudio: {
    ...
    subtitle: "Create professional visuals for your social media",
    steps: {
      product: {
        title: "Select a product",
        subtitle: "Choose the product to highlight",
        search: "Search for a product...",
        selected: "selected",
      },
      template: {
        title: "Choose a template",
        subtitle: "Select the visual style",
      },
      options: {
        title: "Generation options",
        subtitle: "Customize your creative",
        mode: "Mode",
        showcase: "Showcase",
        showcaseDesc: "Elegant presentation",
        strengths: "Strengths",
        strengthsDesc: "Key features",
        display: "Display",
        showPrice: "Show price",
        resetBackground: "Reset background",
        whiteBackground: "AI White background",
        productData: "Product data",
        dataEnrichment: "This data enriches the generation",
        noEnrichedData: "No enriched data",
        selectProduct: "Select a product",
      },
      caption: {
        title: "Tagline",
        subtitle: "Optional - leave empty for auto generation",
        placeholder: "Ex: Limited offer! -30% on this product...",
      },
      social: {
        title: "Social posting",
        subtitle: "Configure posting to your networks",
        platform: "Platform",
        selectPages: "Connected pages",
        noPages: "Connect your pages in settings",
        postLength: "Post length",
        short: "Short",
        shortDesc: "4 lines + hashtags",
        long: "Long",
        longDesc: "10 detailed lines",
        postType: "Post type",
        imageOnly: "Image only",
        imageOnlyDesc: "Visual without clickable link",
        withLink: "With link",
        withLinkDesc: "Link to product page",
        cost: "Cost: 10 optimizations",
      },
    },
    generate: {
      ready: "Ready to generate?",
      configured: "All settings are configured",
      incomplete: "Complete the steps above",
    ...
    result: {
      ...
      editableCaption: "Editable caption",
      edit: "Edit",
      close: "Close",
      noCaption: "No caption generated",
      download: "Download",
      publish: "Publish",
    },
    toast: {
      ...
      whiteBackgroundApplied: "White background applied!",
      whiteBackgroundError: "Error applying white background",
