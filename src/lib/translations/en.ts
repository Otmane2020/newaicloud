export const translations = {
  ...
  seoAuditDashboard: {
    ...
    categoryDescriptions: {
      ...
      pages: "Static pages optimization",
      articles: "Blog articles optimization",
      tags: "Product tags score",
    },
    homepageSection: {
    ...
    synthesis: {
      title: "Summary & Priority Actions",
      subtitle: "Recommendations based on your SEO analysis",
      strengths: "Strengths",
      priorities: "Improvement Priorities",
      noPriority: "No urgent priority detected ✓",
      continueEfforts: "Continue your optimization efforts",
      productsOptimized: "Products well optimized",
      collectionsOptimized: "Collections performing well",
      imagesOptimized: "Images correctly described",
      articlesOptimized: "Articles well structured",
    ...
    quickWins: {
      title: "Quick Wins ⚡ - High Impact Quick Actions",
      subtitle: "{{count}} immediate improvement opportunities",
      actions: "actions",
      notAvailable: "Quick Wins not available",
      notAvailableDesc: "This feature requires a new audit. Regenerate your audit to discover quick actions that will have the most impact on your SEO.",
      generatingAudit: "Generating...",
      generateNewAudit: "Generate a new audit",
    ...
    badges: {
      uniquePage: "Single page",
      products: "products",
    },
    buttons: {
      viewQuickWins: "View Quick Wins",
      fullActionPlan: "Full Action Plan",
    },
  },

  seoAuditReports: {
    title: "Automatic SEO Reports",
    ...
    loading: {
      title: "We're making your SEO Audit",
      ...
      steps: {
        ...
        articles: "Analyzing blog articles...",
    ...
    globalScore: {
      title: "Global SEO Score",
      evaluationBased: "Overall evaluation based on 6 audit categories",
      excellent: "Excellent work!",
      good: "Good SEO level",
      needsImprovement: "Improvements needed",
      urgent: "Urgent optimization required",
    },
    detailedAudit: {
      title: "Detailed audit by category",
      description: "In-depth analysis of each SEO aspect",
    },
    categories: {
      titleQuality: "SEO title quality",
      descriptionQuality: "Meta description quality",
      ...
      pageNotImported: "Page not imported",
      shopifySync: "Shopify sync and technical optimizations",
    },
    recommendations: {
      title: "Priority recommendations",
      description: "Actions to take to improve your SEO",
      urgent: "URGENT",
      important: "IMPORTANT",
      improvement: "IMPROVEMENT",
      excellentWork: "Excellent work! 🎉",
      excellentDesc: "Your SEO optimization is top-notch. Keep maintaining this level of excellence.",
      homepageMissing: "Homepage SEO missing or not optimized (high impact)",
      criticalAlt: "images with critical ALT text",
      problematicTitles: "products with problematic SEO titles",
      problematicDescs: "products with problematic SEO descriptions",
      contentToImprove: "Content quality to improve (descriptions, tags)",
      optimizeTitles: "Optimize SEO titles",
      improveDescs: "Improve SEO descriptions",
      enrichAlts: "Enrich ALT texts",
    },
    detailedIssues: {
      title: "Detected issues details",
      description: "Click to see specific issues by category",
      titleIssues: "SEO title issues",
      descIssues: "Meta description issues",
      altIssues: "ALT text issues",
    ...
    campaignWizard: {
      ...
      steps: {
        basicInfo: {
          ...
          subtitle: "Let's start by naming your campaign",
        },
        topicKeywords: {
          title: "Topic and Keywords",
          subtitle: "Define the theme and SEO keywords",
        },
        audience: {
          title: "Target Audience",
          subtitle: "Who are your articles for?",
        },
        scheduling: {
          title: "Scheduling",
          subtitle: "Configure the publication rhythm",
        },
      },
      fields: {
        campaignName: "Campaign name *",
        ...
        mainTopicPlaceholder: "Ex: Scandinavian furniture, Modern decoration...",
        mainTopicHint: "The general theme of articles to generate",
        keywords: "SEO Keywords",
        keywordsPlaceholder: "Enter a keyword...",
        keywordsHint: "Add relevant keywords for your campaign",
        addKeyword: "Add",
      ...
      toasts: {
        ...
        enterMainTopic: "Please define the main topic",
        notAuthenticated: "Not authenticated",
        campaignLimitReached: "Campaign limit reached",
        upgradeRequired: "Upgrade to a paid plan to create campaigns.",
        monthlyLimitReached: "Monthly limit reached.",
        campaignCreated: "Campaign created successfully!",
        creationError: "Error creating campaign",
      },
