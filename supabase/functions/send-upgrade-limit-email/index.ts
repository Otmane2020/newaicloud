  ...
  try {
    ...
    const translations = {
      fr: {
        ...
        upgrade:
          "Pour continuer à optimiser votre boutique Shopify sans limite, passez à un plan supérieur et débloquez plus de fonctionnalités !",
      ...
      en: {
        ...
        upgrade:
          "To continue optimizing your Shopify store without limits, upgrade to a higher plan and unlock more features!",
