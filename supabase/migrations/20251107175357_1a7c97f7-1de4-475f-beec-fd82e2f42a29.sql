-- Fix increment_usage function - change v_month from text to date
...
AS $function$
DECLARE
  v_month date;  -- Changed from text to date
  v_current_count integer;
  v_max_limit integer;
  v_new_count integer;
  v_current_plan_id text;
BEGIN
  -- Use date_trunc to get the first day of the current month as date type
